<?php
	if(user::isLogged()){
		if($lvl<2){
			breadcrumbs('Zarządzanie słowami kluczowymi');
?>
<h1 class="font20">Zarządzanie słowami kluczowymi</h1>
<div class="margin_ver_15"><a class="btn btn-warning" href="index.php?menu=33">Dodaj słowo kluczowe</a></div>
...
<?php
			...
			else echo '<p>Nastąpił błąd przy pobieraniu informacji o słowach kluczowych: '.implode(' ',$DB->errorInfo()).'.</p>';
		}
