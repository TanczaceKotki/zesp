<?php
	if(user::isLogged()){
		if($lvl<2){
			breadcrumbs('Zarządzanie projektami');
?>
<h1 class="font20">Zarządzanie projektami</h1>
<div class="margin_ver_15"><a class="btn btn-warning" href="index.php?menu=24">Dodaj projekt</a></div>
<?php
...
<table class="table table-striped">
	...
	<?php
		while($row=$result->fetch(PDO::FETCH_ASSOC)){
			?><tr>
				<td>
					<a href="index.php?menu=51&amp;id=<?php echo $row['id']; ?>"><?php echo htmlspecialchars($row['nazwa'],ENT_QUOTES|ENT_HTML5,'UTF-8',false); ?></a>
				</td>
				<td>
...
<?php
			...
			else echo '<p>Nastąpił błąd przy pobieraniu informacji o projektach: '.implode(' ',$DB->errorInfo()).'.</p>';
		}
