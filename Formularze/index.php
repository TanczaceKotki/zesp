    ...
    <body>
        ...
        <div class="container">
            <div id="header" class="header">
                ...
                <?php
                    if (user::isLogged()) echo '<button type="button" class="btn btn-warning btn-xs loginout" href="index.php?menu=15">wyloguj</button>';
                    else echo '<button type="button" class="btn btn-warning btn-xs loginout" href="index.php?menu=10">zaloguj</button>';
                ?>
<!--                search bar -->
...
<!--                experimental part -->
                <nav>
                  <ul class="nav nav-justified menu_niezalogowany">
                    <li class="active"><a href="index.php?menu=1">O projekcie</a></li>
